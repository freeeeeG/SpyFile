...
namespace InControl
{
	...
	{
		// Token: 0x06000C70 RID: 3184 RVA: 0x0003F82F File Offset: 0x0003DC2F
		...
		// Token: 0x06000C71 RID: 3185 RVA: 0x0003F84D File Offset: 0x0003DC4D
		...
		// (get) Token: 0x06000C72 RID: 3186 RVA: 0x0003F86C File Offset: 0x0003DC6C
		...
		// (get) Token: 0x06000C73 RID: 3187 RVA: 0x0003F8A9 File Offset: 0x0003DCA9
		public string Name
		{
			get
			{
		...
		// (get) Token: 0x06000C74 RID: 3188 RVA: 0x0003F8CD File Offset: 0x0003DCCD
		public Key Key
		{
			get
			{
		...
		public static readonly KeyInfo[] KeyList = new KeyInfo[]
		{
			...
			new KeyInfo(Key.Mouse0, "Mouse 0", new KeyCode[]
			{
				KeyCode.Mouse0
			}),
			new KeyInfo(Key.Mouse1, "Mouse 1", new KeyCode[]
			{
				KeyCode.Mouse1
			}),
			new KeyInfo(Key.Mouse2, "Mouse 2", new KeyCode[]
			{
				KeyCode.Mouse2
			}),
			new KeyInfo(Key.Mouse3, "Mouse 3", new KeyCode[]
			{
				KeyCode.Mouse3
			}),
			new KeyInfo(Key.Mouse4, "Mouse 4", new KeyCode[]
			{
				KeyCode.Mouse4
			})
		};
