...
public class ClientCannonCosmeticDecisions : ClientSynchroniserBase
{
	...
	public override void StartSynchronising(Component synchronisedObject)
	{
		...
		this.m_clientCannon = base.gameObject.RequireComponent<ClientCannon>();
		this.m_cannon = base.gameObject.RequireComponent<Cannon>();
		this.m_animator = this.m_cannonCosmeticDecisions.m_cannonAnimator;
		this.m_clientCannon.RegisterOnLoadedCallback(new VoidGeneric<GameObject>(this.Load));
		this.m_clientCannon.RegisterOnUnloadedCallback(new VoidGeneric<GameObject>(this.Unload));
		this.m_clientCannon.RegisterOnLaunchedCallback(new VoidGeneric<GameObject>(this.Launch));
